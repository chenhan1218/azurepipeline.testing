...
# run cartographer
./xvfb.py $DIR/record-cartographer.sh roslaunch $DIR/offline_demo.launch rviz_config:=$DIR/offline.rviz bag_filenames:=$DIR/kitti_2011_09_30_drive_0028_synced.bag
